...
import { Task } from "@/app/constants/TaskList";
...
export default function Home() {
  ...
  function handleSort() {
    ...
    const temp = allTasks[dragTask.current];
    allTasks[dragTask.current] = allTasks[draggedOverTask.current];
    allTasks[draggedOverTask.current] = temp;
    setTasks(allTasks);
  }
